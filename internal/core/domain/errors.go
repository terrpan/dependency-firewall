...
var (
	...
	ErrProxyInstallationNotFound      = errors.New("proxy installation not found")
	ErrProxyInstallationNameConflict  = errors.New("proxy installation name already exists")
	ErrProxyInstallationRevoked       = errors.New("proxy installation revoked")
	ErrProxyEnrollmentNotFound        = errors.New("proxy enrollment not found")
	ErrProxyEnrollmentInvalid         = errors.New("invalid proxy enrollment")
	ErrProxyEnrollmentPending         = errors.New("proxy enrollment authorization pending")
	ErrProxyEnrollmentDenied          = errors.New("proxy enrollment access denied")
	ErrProxyEnrollmentExpired         = errors.New("proxy enrollment expired")
	ErrProxyEnrollmentConsumed        = errors.New("proxy enrollment already consumed")
	ErrProxyEnrollmentSlowDown        = errors.New("proxy enrollment polling too quickly")
	ErrProxyEnrollmentConflict        = errors.New("proxy enrollment state conflict")
)
