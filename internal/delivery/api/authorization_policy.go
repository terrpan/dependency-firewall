...
var controlPlaneOperationPolicies = map[string]OperationAuthorizationPolicy{
	...
	"create-account-policy":        {AuthenticationRequired: true, Permission: domain.PermissionPoliciesWrite, FreshMembership: true, ScopedAuthorization: true},
	"list-account-policies":        {AuthenticationRequired: true, Permission: domain.PermissionPoliciesRead, ScopedAuthorization: true},
	"get-account-policy":           {AuthenticationRequired: true, Permission: domain.PermissionPoliciesRead, ScopedAuthorization: true},
	"update-account-policy":        {AuthenticationRequired: true, Permission: domain.PermissionPoliciesWrite, FreshMembership: true, ScopedAuthorization: true},
	"delete-account-policy":        {AuthenticationRequired: true, Permission: domain.PermissionPoliciesDelete, FreshMembership: true, ScopedAuthorization: true},
	"create-organization-policy":   {AuthenticationRequired: true, Permission: domain.PermissionPoliciesWrite, ScopedAuthorization: true},
	"list-organization-policies":   {AuthenticationRequired: true, Permission: domain.PermissionPoliciesRead, ScopedAuthorization: true},
	"get-organization-policy":      {AuthenticationRequired: true, Permission: domain.PermissionPoliciesRead, ScopedAuthorization: true},
	"update-organization-policy":   {AuthenticationRequired: true, Permission: domain.PermissionPoliciesWrite, ScopedAuthorization: true},
	"delete-organization-policy":   {AuthenticationRequired: true, Permission: domain.PermissionPoliciesDelete, ScopedAuthorization: true},
	"create-account-upstream":      {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, FreshMembership: true, ScopedAuthorization: true},
	"list-account-upstreams":       {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"get-account-upstream":         {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"update-account-upstream":      {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, FreshMembership: true, ScopedAuthorization: true},
	"delete-account-upstream":      {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsDelete, FreshMembership: true, ScopedAuthorization: true},
	"create-organization-upstream": {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, ScopedAuthorization: true},
	"list-organization-upstreams":  {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"get-organization-upstream":    {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"update-organization-upstream": {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, ScopedAuthorization: true},
	"delete-organization-upstream": {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsDelete, ScopedAuthorization: true},
	"create-team-upstream":         {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, ScopedAuthorization: true},
	"list-team-upstreams":          {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"get-team-upstream":            {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsRead, ScopedAuthorization: true},
	"update-team-upstream":         {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsWrite, ScopedAuthorization: true},
	"delete-team-upstream":         {AuthenticationRequired: true, Permission: domain.PermissionUpstreamsDelete, ScopedAuthorization: true},
}
