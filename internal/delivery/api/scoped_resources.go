...
func (h *ScopedResourceHandler) registerPolicyRoutes(api huma.API) {
	h.registerAccountPolicyRoutes(api)
	h.registerOrganizationPolicyRoutes(api)
}

func (h *ScopedResourceHandler) registerAccountPolicyRoutes(api huma.API) {
	huma.Register(
		api,
		scopedOperation(
	...
	huma.Register(
		...
		scopedOperation(
			"get-account-policy",
			http.MethodGet,
			"/api/v1/account/policies/{policy_id}",
			"Get an account policy",
			0,
			"policies",
		),
		h.getAccountPolicy,
	...
	huma.Register(
		...
		scopedOperation(
			...
			http.MethodPut,
			"/api/v1/account/policies/{policy_id}",
			"Update an account policy",
			0,
			"policies",
		),
		h.updateAccountPolicyWithBody,
	)
	huma.Register(
		api,
		scopedOperation(
...
func (h *ScopedResourceHandler) registerOrganizationPolicyRoutes(api huma.API) {
	...
	huma.Register(
		...
		scopedOperation(
			...
			http.MethodGet,
			organizationPath+"/{policy_id}",
			"Get an Organization policy",
			0,
			"policies",
		),
		h.getOrganizationPolicy,
	)
	huma.Register(
		api,
		scopedOperation(
		...
		h.updateOrganizationPolicyWithBody,
	)
	huma.Register(
		api,
		scopedOperation(
...
func (h *ScopedResourceHandler) registerUpstreamRoutes(api huma.API) {
	h.registerAccountUpstreamRoutes(api)
	h.registerOrganizationUpstreamRoutes(api)
	h.registerTeamUpstreamRoutes(api)
}

func (h *ScopedResourceHandler) registerAccountUpstreamRoutes(api huma.API) {
	huma.Register(
		api,
		scopedOperation(
			"create-account-upstream",
			http.MethodPost,
			"/api/v1/account/upstreams",
			"Create a Tenant-shared upstream",
			http.StatusCreated,
			"upstreams",
		),
		h.createAccountUpstream,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodGet,
			"/api/v1/account/upstreams",
			"List Tenant-shared upstreams",
			0,
			"upstreams",
		),
		h.listAccountUpstreams,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodGet,
			"/api/v1/account/upstreams/{upstream_id}",
			"Get a Tenant-shared upstream",
			0,
			"upstreams",
		),
		h.getAccountUpstream,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodPut,
			"/api/v1/account/upstreams/{upstream_id}",
			"Update a Tenant-shared upstream",
			0,
			"upstreams",
		),
		h.updateAccountUpstreamWithBody,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodDelete,
			"/api/v1/account/upstreams/{upstream_id}",
			"Delete a Tenant-shared upstream",
			http.StatusNoContent,
			"upstreams",
		),
		h.deleteAccountUpstream,
	)
...
func (h *ScopedResourceHandler) registerOrganizationUpstreamRoutes(api huma.API) {
	...
	huma.Register(
		...
		scopedOperation(
			...
			http.MethodPost,
			organizationPath,
			"Create an Organization-shared upstream",
			http.StatusCreated,
			"upstreams",
		),
		h.createOrganizationUpstream,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodGet,
			organizationPath,
			"List Organization-shared upstreams",
			0,
			"upstreams",
		),
		h.listOrganizationUpstreams,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodGet,
			organizationPath+"/{upstream_id}",
			"Get an Organization-shared upstream",
			0,
			"upstreams",
		),
		h.getOrganizationUpstream,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodPut,
			organizationPath+"/{upstream_id}",
			"Update an Organization-shared upstream",
			0,
			"upstreams",
		),
		h.updateOrganizationUpstreamWithBody,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodDelete,
			organizationPath+"/{upstream_id}",
			"Delete an Organization-shared upstream",
			http.StatusNoContent,
			"upstreams",
		),
		h.deleteOrganizationUpstream,
	)
	removeValidationResponse(api, organizationPath, http.MethodGet, http.MethodPost)
	removeValidationResponse(api, organizationPath+"/{upstream_id}", http.MethodGet, http.MethodPut, http.MethodDelete)
}

func (h *ScopedResourceHandler) registerTeamUpstreamRoutes(api huma.API) {
	...
	huma.Register(
		...
		scopedOperation(
			...
			http.MethodPost,
			teamPath,
			"Create a Team-local upstream",
			http.StatusCreated,
			"upstreams",
		),
		h.createTeamUpstream,
	)
	huma.Register(
		api,
		scopedOperation("list-team-upstreams", http.MethodGet, teamPath, "List Team-local upstreams", 0, "upstreams"),
		h.listTeamUpstreams,
	)
	huma.Register(
		api,
		scopedOperation(
			"get-team-upstream",
			http.MethodGet,
			teamPath+"/{upstream_id}",
			"Get a Team-local upstream",
			0,
			"upstreams",
		),
		h.getTeamUpstream,
	...
	huma.Register(
		...
		scopedOperation(
			...
			http.MethodPut,
			teamPath+"/{upstream_id}",
			"Update a Team-local upstream",
			0,
			"upstreams",
		),
		h.updateTeamUpstreamWithBody,
	)
	huma.Register(
		api,
		scopedOperation(
			...
			http.MethodDelete,
			teamPath+"/{upstream_id}",
			"Delete a Team-local upstream",
			http.StatusNoContent,
			"upstreams",
		),
		h.deleteTeamUpstream,
	)
...
func (h *ScopedResourceHandler) createAccountPolicy(
	ctx context.Context,
...
func (h *ScopedResourceHandler) getAccountPolicy(
	ctx context.Context,
	input *accountPolicyIDInput,
) (*policyOutput, error) {
	principal, err := hierarchyPrincipal(ctx)
	if err != nil {
		return nil, err
...
func (h *ScopedResourceHandler) updateAccountPolicyWithBody(
	ctx context.Context,
	input *updateAccountPolicyInput,
) (*policyOutput, error) {
	principal, err := hierarchyPrincipal(ctx)
	if err != nil {
		return nil, err
...
func (h *ScopedResourceHandler) deleteAccountPolicy(
	ctx context.Context,
...
func (h *ScopedResourceHandler) createOrganizationPolicy(
	ctx context.Context,
...
func (h *ScopedResourceHandler) listOrganizationPolicies(
	ctx context.Context,
	input *organizationPathInput,
) (*policyListOutput, error) {
	principal, err := hierarchyPrincipal(ctx)
	if err != nil {
		return nil, err
	}
...
func (h *ScopedResourceHandler) getOrganizationPolicy(
	ctx context.Context,
	input *organizationPolicyIDInput,
) (*policyOutput, error) {
	principal, err := hierarchyPrincipal(ctx)
	if err != nil {
		return nil, err
...
func (h *ScopedResourceHandler) updateOrganizationPolicyWithBody(
	ctx context.Context,
...
func (h *ScopedResourceHandler) deleteOrganizationPolicy(
	ctx context.Context,
	input *deleteOrganizationPolicyInput,
) (*struct{}, error) {
	principal, err := hierarchyPrincipal(ctx)
	if err != nil {
		return nil, err
	}
	if err := h.policies.DeleteOrganization(
		ctx,
		principal,
...
func (h *ScopedResourceHandler) createAccountUpstream(
	ctx context.Context,
	input *accountUpstreamInput,
) (*upstreamOutput, error) {
	return h.createScopedUpstream(ctx, domain.AuthorizationScope{}, input.Body)
}

func (h *ScopedResourceHandler) createOrganizationUpstream(
	ctx context.Context,
	input *organizationUpstreamInput,
) (*upstreamOutput, error) {
	return h.createScopedUpstream(ctx, domain.AuthorizationScope{OrganizationID: input.OrganizationID}, input.Body)
}

func (h *ScopedResourceHandler) createTeamUpstream(
	ctx context.Context,
	input *teamUpstreamInput,
) (*upstreamOutput, error) {
	return h.createScopedUpstream(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID, TeamID: input.TeamID},
		input.Body,
	)
}
...
func (h *ScopedResourceHandler) listOrganizationUpstreams(
	ctx context.Context,
	input *organizationPathInput,
) (*upstreamListOutput, error) {
	return h.listScopedUpstreams(ctx, domain.AuthorizationScope{OrganizationID: input.OrganizationID})
}

func (h *ScopedResourceHandler) listTeamUpstreams(
	ctx context.Context,
	input *teamPathInput,
) (*upstreamListOutput, error) {
	return h.listScopedUpstreams(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID, TeamID: input.TeamID},
	)
}

func (h *ScopedResourceHandler) getAccountUpstream(
	ctx context.Context,
	input *accountUpstreamIDInput,
) (*upstreamOutput, error) {
	return h.getScopedUpstream(ctx, domain.AuthorizationScope{}, input.UpstreamID)
}

func (h *ScopedResourceHandler) getOrganizationUpstream(
	ctx context.Context,
	input *organizationUpstreamIDInput,
) (*upstreamOutput, error) {
	return h.getScopedUpstream(ctx, domain.AuthorizationScope{OrganizationID: input.OrganizationID}, input.UpstreamID)
}

func (h *ScopedResourceHandler) getTeamUpstream(
	ctx context.Context,
	input *teamUpstreamIDInput,
) (*upstreamOutput, error) {
	return h.getScopedUpstream(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID, TeamID: input.TeamID},
		input.UpstreamID,
	)
...
func (h *ScopedResourceHandler) updateAccountUpstreamWithBody(
	ctx context.Context,
	input *updateAccountUpstreamInput,
) (*upstreamOutput, error) {
	return h.updateScopedUpstream(ctx, domain.AuthorizationScope{}, input.UpstreamID, input.Body)
}

func (h *ScopedResourceHandler) updateOrganizationUpstreamWithBody(
	ctx context.Context,
	input *updateOrganizationUpstreamInput,
) (*upstreamOutput, error) {
	return h.updateScopedUpstream(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID},
		input.UpstreamID,
		input.Body,
	)
}

func (h *ScopedResourceHandler) updateTeamUpstreamWithBody(
	ctx context.Context,
	input *updateTeamUpstreamInput,
) (*upstreamOutput, error) {
	return h.updateScopedUpstream(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID, TeamID: input.TeamID},
...
func (h *ScopedResourceHandler) deleteAccountUpstream(
	ctx context.Context,
	input *accountUpstreamIDInput,
) (*struct{}, error) {
...
func (h *ScopedResourceHandler) deleteOrganizationUpstream(
	ctx context.Context,
	input *organizationUpstreamIDInput,
) (*struct{}, error) {
	return h.deleteScopedUpstream(
		ctx,
		domain.AuthorizationScope{OrganizationID: input.OrganizationID},
		input.UpstreamID,
	)
...
func (h *ScopedResourceHandler) createScopedUpstream(
	ctx context.Context,
...
func (h *ScopedResourceHandler) listScopedUpstreams(
	ctx context.Context,
	scope domain.AuthorizationScope,
) (*upstreamListOutput, error) {
	principal, err := hierarchyPrincipal(ctx)
...
func (h *ScopedResourceHandler) getScopedUpstream(
	ctx context.Context,
	scope domain.AuthorizationScope,
	id string,
) (*upstreamOutput, error) {
...
func (h *ScopedResourceHandler) updateScopedUpstream(
	ctx context.Context,
	scope domain.AuthorizationScope,
	id string,
	req createUpstreamRequest,
...
func (h *ScopedResourceHandler) deleteScopedUpstream(
	ctx context.Context,
	scope domain.AuthorizationScope,
	id string,
) (*struct{}, error) {
...
//nolint:gocyclo // error classification switch
func (h *ScopedResourceHandler) scopedError(ctx context.Context, operation string, err error) error {
	if errors.Is(err, domain.ErrPolicyNotFound) || errors.Is(err, domain.ErrUpstreamNotFound) ||
	...
	if errors.As(err, &denial) {
		...
		case domain.AuthorizationDenialTenantMismatch,
			domain.AuthorizationDenialOrganizationNotFound,
			domain.AuthorizationDenialTeamNotFound:
			return huma.Error404NotFound("resource not found")
		default:
			return huma.Error403Forbidden("insufficient permission for this scope")
		}
	}
	if errors.Is(err, domain.ErrPolicyNameConflict) || errors.Is(err, domain.ErrUpstreamNameConflict) ||
		errors.Is(err, domain.ErrUpstreamRegistryConflict) {
		return huma.Error409Conflict("name or registry already exists in this scope")
	}
	if errors.Is(err, domain.ErrPolicyDeleteEnabled) || errors.Is(err, domain.ErrPolicyInUse) ||
		errors.Is(err, domain.ErrUpstreamInUse) {
	...
	if errors.Is(err, domain.ErrInvalidPolicy) || errors.Is(err, domain.ErrUnsupportedPolicySchemaVersion) ||
		...
		errors.Is(err, domain.ErrInvalidResourceScope) ||
		errors.Is(err, domain.ErrUnsupportedUpstreamCapability) ||
		errors.Is(err, domain.ErrUpstreamPolicyConflict) ||
		errors.Is(err, domain.ErrUpstreamAuthInvalid) ||
		errors.Is(err, domain.ErrUpstreamAuthKeyUnavailable) ||
