      ...
      <div className={styles.layout}>
        ...
        <Panel padding="lg">
          <form className={styles.form} onSubmit={createTenant}>
            ...
            <h3>Create tenant</h3>
            <p>Tenant identifiers are generated by the control plane and remain separate from identity-provider organizations.</p>
            <Field label="Display name" hint="Use a team or business-unit name."><Input autoComplete="organization" maxLength={120} onChange={event => setName(event.target.value)} placeholder="Platform Engineering" required value={name} /></Field>
