      ...
      {currentPolicy && comparisonVersion ? (
        <div className={policyClass("policy-diff-modal")}>
          ...
          <div className={policyClass("policy-diff-summary")}>
            <span className={policyClass("policy-badge policy-badge-muted")}>Retained version {comparisonVersion.version}</span>
            <span className={policyClass("policy-badge policy-badge-info")}>Current version {currentPolicy.version}</span>
            {!hasChanges ? <span className={policyClass("status-pill status-pill-neutral")}>No definition changes</span> : null}
          </div>
